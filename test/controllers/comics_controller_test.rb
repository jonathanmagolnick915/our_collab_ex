...
class ComicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post comics_url, params: { comic: { brand: @comic.brand, category_id: @comic.category_id, description: @comic.description, name: @comic.name, price: @comic.price, rating: @comic.rating } }
    end
  ...
  test "should update comic" do
    patch comic_url(@comic), params: { comic: { brand: @comic.brand, category_id: @comic.category_id, description: @comic.description, name: @comic.name, price: @comic.price, rating: @comic.rating } }
